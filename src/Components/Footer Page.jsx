...
export default function FooterSection(){
  ...
  <footer className="py-5">
    ...
    <div className="d-flex flex-column flex-sm-row justify-content-between py-4 my-4 border-top">
      <p className="text-light">© <u>Your Site Name ,</u> All Right Reserved. Designed By <u>HTML Codex</u><br/> <br/>Distributed By<u> ThemeWagon</u></p><br/>
    
       <ul class="list-unstyled d-flex">
        <li class="ms-3"><a class="text-decoration-none text-light" href="#">Home</a></li>
        <li class="ms-3"><a class="text-decoration-none text-light" href="#">Cookies</a></li>
        <li class="ms-3"><a class="text-decoration-none text-light" href="#">Help</a></li>
        <li class="ms-3"><a class="text-decoration-none text-light" href="#">FQAs</a></li>
      </ul> 
    </div> 
  </footer>
</div>
